...
- [x] 1. Create Persistence Service
  ...
  - [x] 1.2 Write property test for save/load round trip (Note: Skipped - requires Electron mocking)
...
- [ ] 2. Create Git Watcher Service
  ...
  - [x] 2.2 Add IPC channel for commit events
...
- [x] 3. Update Pet Store for Commit-Based Feeding
  ...
  - [x] 3.2 Implement feedFromCommit action
...
- [x] 5. Implement Pet Revival
  ...
  - [x] 5.3 Write property tests for revival
...
- [x] 6. Wire Up Main Process
  ...
  - [x] 6.2 Update src/preload/index.ts
    - Add IPC handlers for commit events
    - Add IPC handlers for save/load
    - _Requirements: 1.5, 2.3_

- [x] 7. Wire Up Renderer
  - [x] 7.1 Update App.tsx to handle commit events
  ...
  - [x] 7.2 Apply decay on app startup
...
- [x] 8. Update Activity Log
  - [x] 8.1 Add commit entry type to ActivityLog.tsx
    - Display commit icon and message
    - Show truncated commit message (50 chars)
    - _Requirements: 5.1, 5.2, 5.3_
  
  - [x] 8.2 Add resurrection entry type
    - Display special resurrection message

    - _Requirements: 5.4_

- [x] 9. Update Debug Panel
  - [x] 9.1 Add commit simulation controls
...
- [x] 10. Update File Watcher Behavior
  - [x] 10.1 Modify file save handling
    - Keep Activity Log entries for file saves
    - Remove HP/XP gain from file saves
    - Add subtle visual feedback only
    - _Requirements: 6.1, 6.2, 6.3_

- [x] 11. Add Revival Animation
  - [x] 11.1 Create resurrection visual effect
    - Flash effect or animation when pet revives
    - Display "RESURRECTED" message
    - _Requirements: 4.5_

- [x] 12. Final Checkpoint
  - TypeScript compiles successfully, property tests implemented and passing

## Phase 7: Hook Update (Optional)

- [x] 13. Update Crypt Keeper Hook
  - [x] 13.1 Modify hook to trigger on git commits
