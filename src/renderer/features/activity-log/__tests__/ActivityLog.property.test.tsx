      ...
      fc.property(
        ...
        (events) => {
          ...
          entries.forEach((entry) => {
            ...
            const expectedLabel = entry.type === 'commit' ? 'FED' : 'RESURRECTED';
    ...
    fc.assert(
      fc.property(
        ...
        (events) => {
          ...
          const resurrectionEntries = entries.filter(e => e.type === 'resurrection');

          if (commitEntries.length > 0) {
            expect(container.textContent).toContain('FED');
          }

          if (resurrectionEntries.length > 0) {
            expect(container.textContent).toContain('RESURRECTED');
          }
